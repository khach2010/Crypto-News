...
import { useGetCryptoDetailQuery, useGetCryptoHistoryQuery } from '../services/cyptoApi'
  ...
  return (
    <Col className="coin-detail-container">
      ...
      <Col className='coin-heading-container'>
        ...
        <p>{cryptoDetails.name} live price in USD. View coin statistic, market cap and supply.</p>
      </Col>
