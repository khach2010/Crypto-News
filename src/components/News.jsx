...
const { Option } = Select
const demoImage = 'https://academy-public.coinmarketcap.com/optimized-uploads/6632a5444a394dd59921af67e5621cdb.png'
          ...
          <Card hoverable className='news-card'>
            <a href={news.url} target='_blank' rel='noreferrer'>
              <div className='news-image-container'>
                ...
                <img className='new-image-thumbnail' src={news?.image?.thumbnail?.contentUrl || demoImage} alt={news.name} />
              </div>
              <p>
